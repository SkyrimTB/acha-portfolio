---
title: AWS Project🌐
description: A build-out of a fully functional software-as-a-service for genomics annotation.
date: '2024-03-23'
lang: en
tags:
  - SaaS
...
<Image
  src="/assets/images/blog/aws-project/GAS-frameworkpng.png"
  alt="GAS Framwork"
  width={873}
  height={527}
/>

See the complete source code of [AWS Project](https://github.com/SkyrimTB/aws-project)
