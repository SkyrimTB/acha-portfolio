...
description: A modeling system built with Python using Markov Models.
date: '2023-12-29'
lang: en
tags:
  - Python
...
See the complete source code of [Python Project](https://github.com/SkyrimTB/Python_Project)
...
<Image
  src="/assets/images/blog/python-project/hashtable.png"
  alt="GAS Framework"
  width={800}
  height={527}
/>
...
<Image
  src="/assets/images/blog/python-project/obama-mccain.png"
  alt="Obama and McCain"
  width={800}
  height={527}
/>
Markov models are used significantly in speech recognition systems, and used heavily
in the domains of natural language processing, machine learning, and AI.
...
1. For each character in the known text, you generate a string of length `k` that includes the current character plus `k−1` succeeding characters. (_Note:_ The model actually works by finding the `k` preceding letters but our way works too because we are using a wrap-around effect.)
...
<Image
  src="/assets/images/blog/python-project/markov1.png"
  alt="Markov Model Example 1"
  width={800}
  height={527}
/>
...
<Image
  src="/assets/images/blog/python-project/markov2.png"
  alt="Markov Model Example 2"
  width={800}
  height={527}
/>
Most of the `k`and`k+1`strings were only generated once, but some such as`"is"` occur
more than once.
...
<code>python log((M + 1)/(N + S))</code>

For example, lets say you have a file called speakerC.txt (i.e., the unidentified text):
...
<Image
  src="/assets/images/blog/python-project/markov3.png"
  alt="Markov Model Example 3"
  width={800}
  height={527}
/>
...
<code>
  $ python proj/performance.py speeches/bush1+2.txt speeches/kerry1+2.txt
  speeches/bush-kerry3/BUSH-0.txt 2 3
</code>
...
<Image
  src="/assets/images/blog/python-project/graph.png"
...
<code>python sns.pointplot(..., linestyle='-', marker='o')</code>
