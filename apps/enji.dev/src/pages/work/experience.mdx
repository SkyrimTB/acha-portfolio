...
1. Collaborated technical demands of the increasement of Tik Tok Live Streaming features with more than **100 PB data**.
2. Developed and monitored **data pipelines** feeding into machine learning models for current live stream production.
...
3. Merged the old BI system from Tableau into the internal data dashboards
