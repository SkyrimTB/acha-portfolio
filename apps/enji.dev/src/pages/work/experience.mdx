...
**Unversity of Chicago** — **MS in Computer Science** — (Sep 2023 - Mar 2025)
...
**NetEase Games – Marvel Rivals** &nbsp; (July 2025 - Present) — **Combat & Character Designer**

1. Lead to design **a hero of Marvel Rivals S10**, adjustbased on feedback and tests
2. Participated in **Marvel Rivals S7 PVE 2.0 Mode**, respond to Thor hero BD design, coordinating with **AI Agent**
3. Participated in **Marvel Rivals S9 Team-Up 2.0 **rebuild, respond to **17 heroes** and **68 abilities** in total
4. Developed **MCP plugin** supporting **UE 5.3**; Using **AI** filtering **GameplayCue** for **performance optimization**.
...
**Tik Tok - Global Live** &nbsp; (Jul 2024 - Jan 2025) — **Software Engineer Intern**

1. Participated in the construction of **offline & real-time data warehouses** for TikTok Live, handle **PB-level** largescale data
2. Developed a **BOT** based on **Large Language Model (LLM)**, which can translate **data glossary** and **write SQL** internally.
3. Work closely with **Data Product Manager** to improve business strategy of Global Live operation by **data visualization**.
4. Optimized existing data tasks with **higher performance**, merged data across **different regions** and deployed it in **multi servers**.
